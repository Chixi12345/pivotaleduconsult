  ...
  return (
    <div className="admissionProcess-FamGen">
      ...
      <div className="admissionProcess-Famcont">
        {" "}
        <p>
          At Pivotal EduConsult, our world wide network of associates and
          affiliates as well as the existence of a well staffed U.S.A office
      ...
      <div className="admissionProcess-FamBtn">
        <h4>LEARN MORE</h4>
      </div>
    </div>
  );
