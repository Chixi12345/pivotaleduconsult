    ...
    <div>
      ...
      <div className="ieltsPage-bodyGen">
        ...
        <div className="ieltsPage-textComp">
          ...
          English proficiency across the globe. It was established in 1989 and
          is accepted by more than 7,000 organisations worldwide which include
          universities, immigration departments, government agencies,
        ...
        <div className="ieltsPage-textComp">
          ...
          countries. IELTS has two versions – Academic and General Training. The
          Academic test is for those who want to study at a tertiary level in an
          ...
          As a student, you will take the academic version of the exam. Just
          like the TOEFL, IELTS has four sections:
        </div>
        ...
        <div className="ieltsPage-textComp">
          The total test time is 2 hours and 45 minutes. The Listening, Reading
          and Writing tests are done in one sitting. The Speaking test may be on
        ...
        <div className="ieltsPage-textComp">
          ...
          first three sections have a break in the middle allowing candidates to
        ...
        <div className="ieltsPage-textComp">
          In the academic module the reading test comprises three sections, with
          3 texts normally followed by 13 or 14 questions for a total of 40
        ...
        <div className="ieltsPage-textComp">
          ...
          two sections(tasks) but the point of difference is in the task 1. The
          general writing task 1 requires test takers to write a letter
          describing a situation, evaluating or complaining about an issue. The
          timing and numbers of words are required
        </div>
        <div className="ieltsPage-textComp" style={{ fontWeight: "600" }}>
          SPEAKING
        </div>
        <div className="ieltsPage-textComp" style={{ marginBottom: "100px" }}>
          The speaking test contains three sections. The first section takes the
          form of an interview during which candidates may be asked about their
          ...
          examiner and the candidate, generally on questions relating to the
          theme which they have already spoken about in part 2. This last
          section is more abstract, and is usually considered the most
          difficult.
        </div>
      </div>
      <Footer />
