    ...
    <div>
      ...
      <div className="admissionPage-bodyGen">
        ...
        <div className="admissionPage-textComp">
          At BROADWAY, our worldwide network of associates and affiliates as
          well as the existence of a well staffed U.S.A office manned by one of
          our directors has made it possible for us to assist more than 2,000
          Nigerian students in enrolling in more than 300 schools in the United
          States of America and not less 40% of these students have received
          scholarships The visa enrollment in the American Embassy is now more
          hostile and students who have not travelled out of the country before
          are at disadvantage. Our services are designed to enable you overcome
          these disadvantages. High scores notwithstanding, students chances of
          getting admission into an American university as well as his or her
          chances of getting a visa might be destroyed due to poor knowledge and
          skills when it comes to application and admission processing. This is
          due to the fact that there are so many intricate processes involved in
          the processing of applications and admissions into American
          universities. This state of affairs is further aggravated by the
          deadlines which are scrupulously adhered to by American universities
          as well as the various financial implications of application and
          admission processing. Our team of counselors at BROADWAY are head
          above shoulders of their peers when it comes to this crucial part of
          the quest for American education , they are experts at giving good
          advice and counseling when it comes to the choice of universities as
          well as courses. BROADWAY’s team of experienced counselors guides you
          through the arcane and often unfamiliar terrain of American university
          admission process. Our high success rate can be attributed to our one
          on one relationship with the Admission Officers of the various
          universities we deal with. Over the years we have succeeded in
          developing a mutually benefiting relationship with many universities
          in the United States The Counseling Department also gives students the
          information they need to make good career decisions. At BROADWAY,
          counseling is available for those with academic difficulties and
          others who desire test interpretation.
        </div>

        <div>
          BROADWAY counselors give special bits of advice to students on the
        ...
        <div>
          ...
          <div>
            <ul>
              ...
              <li>Electrical Engineering and Related Technologies (EERT)</li>
