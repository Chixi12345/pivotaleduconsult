    ...
    <div>
      ...
      <div className="ptePage-bodyGen">
        ...
        <div className="ptePage-textComp">
          ...
          Graduate Management Admission Test® (GMAT®). The test is recognized by
          universities and colleges worldwide and is officially approved by the
          UK Border Agency for Tiers 1, 2 and 4 visa applications.
        </div>
        <div
        ...
        <div className="ptePage-textComp">
          It is a computer-based exam which focuses on real-life English used in
          academic surroundings. This is to say that integrated language is used
          throughout the test and students will listen to a variety of accents
          and academic language which they will encounter at English-speaking
        ...
        <div className="ptePage-textComp">
          ...
          language proficiency more precisely with reference to the widely known
          set of levels distinguished in the Common European Framework of
          Reference for Languages, or CEFR.
        </div>
        ...
        <div className="ptePage-textComp">
          The test is internationally recognized and is accepted for admissions
          for thousands of programs. PTE Academic acceptance includes top UK
          universities, top US universities and government organizations.
        </div>
